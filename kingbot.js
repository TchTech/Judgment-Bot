...
client.on("message", (msg)=>{
    switch(msg.content.split(" ")[0]){
        case "b!games":
            ...
            break
        case "b!minecraft":
            let minecraft_role = msg.guild.roles.cache.find((role)=>{role.id == "858709693088923658"})
            ...
            break
        case "b!terraria":
            let terraria_role = msg.guild.roles.cache.find((role)=>{role.id == "858714294724329472"})
            ...
            break
        case "b!csgo":
            let csgo_role = msg.guild.roles.cache.find((role)=>{role.id == "858715522370633798"})
            ...
            break
        case "b!wot":
            let wot_role = msg.guild.roles.cache.find((role)=>{role.id == "858715937259388968"})
            msg.member.roles.add(wot_role)
            msg.reply("Вы получили роль `WOT-Gamer`. Теперь вы имеете доступ к категории о **World Of Tanks**.\n*Спасибо за использование нашего сервиса!*")
            break
        case "b!pubg":
            let pubg_role = msg.guild.roles.cache.find((role)=>{role.id == "858716603574386698"})
            ...
            break
        case "b!nintendo":
            let nintendo_role = msg.guild.roles.cache.find((role)=>{role.id == "858717300127301632"})
            ...
            break
        case "b!gta":
            let gta_role = msg.guild.roles.cache.find((role)=>{role.id == "858718793319710720"})
